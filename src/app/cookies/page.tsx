...
export const metadata: Metadata = {
  title: "Política de Cookies · ARC Reformas Tarragona",
  description: "Política de cookies de ARC Reformas Tarragona. Tipo de cookies utilizadas en el sitio y cómo gestionarlas.",
    ...
    <>
      <section className="bg-dark px-5 pt-32 pb-16">
        <div className="mx-auto max-w-[800px] text-center">
          <h1 className="font-display font-extrabold text-[36px] md:text-[52px] text-white leading-[1]">
            Política de Cookies
          </h1>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[800px] font-body text-dark space-y-8">
          ...
          <div>
            ...
            <div className="bg-white rounded-[16px] p-6 border border-dark/5 space-y-6 mt-4">
              <div>
                <h3 className="font-bold text-dark text-base mb-2">Cookies técnicas (necesarias)</h3>
              ...
              <div>
                <h3 className="font-bold text-dark text-base mb-2">Cookies analíticas</h3>
                <p className="text-subtitle text-sm leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-dark text-base mb-2">Cookies de terceros</h3>
                <p className="text-subtitle text-sm leading-relaxed">
              ...
              <table className="w-full text-sm border-collapse mt-4">
                <thead>
                  <tr className="bg-accent/10">
                    <th className="text-left p-3 font-bold text-dark text-xs">Cookie</th>
                    <th className="text-left p-3 font-bold text-dark text-xs">Tipo</th>
                    <th className="text-left p-3 font-bold text-dark text-xs">Duración</th>
                    <th className="text-left p-3 font-bold text-dark text-xs">Finalidad</th>
                  </tr>
                </thead>
          ...
          <div>
            ...
            <p className="text-subtitle leading-relaxed">
              ARC Reformas Tarragona puede modificar esta política para adaptarla a cambios normativos o a las instrucciones de la Agencia Española de Protección de Datos. Se recomienda revisar este apartado de forma periódica.
            </p>
          </div>
