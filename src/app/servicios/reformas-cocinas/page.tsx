...
export const metadata: Metadata = {
  ...
  description:
    "Reformamos cocinas en pisos del Eixample tarraconense, abriendo galerías cerradas y conectando con el comedor. Acabados sobrios, isla central si lo permite la finca. 877 278 165.",
