...
export const metadata: Metadata = {
  ...
  description:
    "Reforma de baños en Tarragona. Sustitución de bañera por plato de obra, accesibilidad mejorada y soluciones para bajantes compartidos en fincas antiguas. 877 278 165.",
