...
export const metadata: Metadata = {
  title: "Página no encontrada · ARC Reformas Tarragona",
    ...
    <section className="bg-dark min-h-[80vh] flex items-center justify-center px-5">
      <div className="text-center max-w-[600px] flex flex-col items-center gap-6">
        ...
        <p className="font-body text-white/50 text-base md:text-lg leading-relaxed">
          Esta dirección no responde a ninguna página activa de la web. Puede que el enlace esté caducado o haya sido trasladado a otra ruta.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-3 mt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-accent text-white px-8 py-4 rounded-full font-display font-bold text-[15px] hover:bg-accent/90 transition-colors"
          >
          ...
          <Link
            href="/contacto"
            className="inline-flex items-center gap-2 border-2 border-white/20 text-white px-7 py-4 rounded-full font-display font-bold text-[15px] hover:bg-white/10 transition-colors"
          >
            Contactar
          </Link>
        </div>
