...
export default function HeroForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-[#2A3040]/95 backdrop-blur-md rounded-2xl p-8 text-center">
        ...
        <h3 className="font-display font-bold text-xl text-white mb-2">Solicitud recibida</h3>
        <p className="font-body text-white/60 text-sm">Revisamos tu petición y te llamamos antes de 24 horas con una valoración inicial.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#2A3040]/95 backdrop-blur-md rounded-2xl p-7 md:p-8 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
        <input type="hidden" name="_subject" value="Nuevo presupuesto desde arcreformastarragona.es (hero)" />
        ...
        <div className="relative">
          <select name="locality" required className={selectClasses} defaultValue="">
            ...
            <option value="Reus" className="text-dark">Reus</option>
            ...
            <option value="Otra" className="text-dark">Otra localidad</option>
          </select>
        ...
        <div className="relative">
          <select name="serviceType" className={selectClasses} defaultValue="">
            ...
            <option value="Piso del Eixample" className="text-dark">Piso del Eixample / centro</option>
            <option value="Edificio histórico Part Alta" className="text-dark">Edificio Part Alta / catalogado</option>
        ...
        <textarea
          name="message"
          placeholder="Describe brevemente la finca y el alcance previsto"
          rows={3}
          className={`${inputClasses} resize-y`}
        />

        <label className="flex items-start gap-2 text-white/60 text-xs">
          <input type="checkbox" name="lopd" required className="mt-0.5 accent-accent" />
          <span>
