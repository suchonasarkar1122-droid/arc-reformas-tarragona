    ...
    <div className="bg-white rounded-[20px] overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 h-full border border-dark/5">
      <div className="relative h-[220px] overflow-hidden">
        <Image
          ...
          loading="lazy"
        />
        <div className="absolute top-4 left-4 w-11 h-11 rounded-xl bg-accent text-white flex items-center justify-center font-display font-black text-lg">
          {step}
        </div>
      </div>
      <div className="p-7">
        <h3 className="font-display font-bold text-dark text-[17px] mb-3">{title}</h3>
